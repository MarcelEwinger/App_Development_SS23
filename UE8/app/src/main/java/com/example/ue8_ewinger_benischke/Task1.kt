...
import com.example.ue8_ewinger_benischke.databinding.ActivityTask1Binding
...
class Task1 : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val binding: ActivityTask1Binding =
            DataBindingUtil.setContentView(this, R.layout.activity_task1)
        binding.apply {
            lifecycleOwner = this@Task1
        ...
        mainViewModel.userNumber.observe(this@Task1) {
        ...
        unitSpinner.onItemSelectedListener = object : AdapterView.OnItemSelectedListener {
            override fun onItemSelected(parent: AdapterView<*>, view: View?, position: Int, id: Long) {
                ...
                val selectedAdapter = ArrayAdapter(this@Task1, android.R.layout.simple_spinner_item, selectedUnitArray!!)
